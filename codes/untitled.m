...
% Calculate errors between original positions and estimated positions
error_LOS = sqrt(sum((staticObjects - estimated_LOS).^2, 2));
error_NLOS = sqrt(sum((staticObjects - repmat(estimated_NLOS, size(staticObjects, 1), 1)).^2, 2));
